...
public class ProductSimulation extends Simulation {
    ...
    ScenarioBuilder browseAllProducts =
    ...
    ScenarioBuilder createAndFindProduct =
            scenario("Create and Find Product")
                    .exec(
                            http("Create Product")
                                    .post("/products")
    ...
    {
        setUp(
                browseAllProducts.injectOpen(rampUsers(100).during(Duration.ofSeconds(20))),
                createAndFindProduct.injectOpen(rampUsers(100).during(Duration.ofSeconds(20))))
